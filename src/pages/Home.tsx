    ...
    >
      ...
      >
        ...
        {isLoggedIn ? (
          ...
          <KakaoLoginButton size="sm">카카오 로그인</KakaoLoginButton>
        )}
      </nav>
      ...
      <div className="flex-1 overflow-y-auto">
          ...
          {[
            {
              ...
              name: "편지를 써요",
              desc: "AI 키워드와 톤앤매너를 선택하고, 하고 싶은 말을 자유롭게 적어보세요.",
            },
            {
              num: "STEP 02",
              icon: "🎨",
            ...
            },
            {
              ...
              iconBg: "#f0f7ff",
              name: "카톡으로 전달해요",
              desc: "링크를 카카오톡으로 공유하면, 받는 분이 아름다운 애니메이션과 함께 열어볼 수 있어요.",
            },
          ].map((s) => (
            <div
              key={s.num}
              className="bg-white rounded-[16px] border border-black/[0.08] p-5"
            >
              <p
                className="text-[12px] font-bold tracking-[0.08em] mb-3"
                style={{
                  fontFamily: "var(--font-serif)",
                  color: "var(--color-rose)",
                }}
              ...
              <div
                className="w-[38px] h-[38px] rounded-[10px] flex items-center justify-center text-[20px] mb-3"
        ...
        <div className="px-5 mb-6">
          <h2
            className="font-bold leading-[1.3] tracking-[-0.02em] mb-4"
            style={{
              fontFamily: "var(--font-serif)",
              color: "var(--color-ink)",
              fontSize: 30,
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              >
                <span
                  className="inline-block text-[10px] font-medium px-[9px] py-[3px] rounded-[6px] mb-3"
                  style={{
                    fontFamily: "var(--font-sans)",
                    background: f.tagBg,
                    color: f.tagColor,
        ...
        <div className="px-5 pb-8">
          <div
            className="rounded-[20px] px-6 py-8 text-center relative overflow-hidden"
          ...
          >
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 60% 80% at 50% 50%, rgba(232,82,106,0.18), transparent 70%)",
              }}
            />
            <div className="relative z-10">
              <h2
                className="font-bold leading-[1.3] text-white mb-2"
